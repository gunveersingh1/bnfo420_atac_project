...
Cardiometabolic diseases, including diabetes, obesity, and non-alcoholic fatty liver disease (NAFLD), are increasing globally and represent a major public health concern. The liver plays a central role in lipid metabolism, glucose homeostasis, and overall energy balance, making it a key organ in disease progression ([Cohen et al., 2011](https://pubmed.ncbi.nlm.nih.gov/21435875/); [Tilg et al., 2017](https://pubmed.ncbi.nlm.nih.gov/28507044/)). While genome-wide association studies (GWAS) have identified many genetic variants linked to cardiometabolic disease, the biological mechanisms connecting these variants to gene expression remain unclear ([Visscher et al., 2017](https://pubmed.ncbi.nlm.nih.gov/28586856/); [Schmitt et al., 2015](https://pubmed.ncbi.nlm.nih.gov/25559105/)).

Chromatin accessibility is a key factor influencing gene regulation. Chromatin consists of DNA wrapped around histone proteins and can exist in either an open or closed state, directly impacting transcriptional activity ([Kornberg, 1974](https://pubmed.ncbi.nlm.nih.gov/4825889/); [Thurman et al., 2012](https://pubmed.ncbi.nlm.nih.gov/22955617/)). In open chromatin regions, transcription factors can bind DNA and activate gene expression, while closed chromatin restricts access ([Buenrostro et al., 2013](https://pubmed.ncbi.nlm.nih.gov/24097267/); [Roadmap Epigenomics Consortium, 2015](https://pubmed.ncbi.nlm.nih.gov/25693563/)). These accessible regions are often located in regulatory elements such as promoters, enhancers, and introns, which play critical roles in controlling gene expression ([ENCODE Project Consortium, 2012](https://pubmed.ncbi.nlm.nih.gov/22955616/); [Andersson et al., 2014](https://pubmed.ncbi.nlm.nih.gov/24670763/)).

ATAC-seq (Assay for Transposase-Accessible Chromatin using sequencing) is a widely used technique to identify open chromatin regions across the genome ([Buenrostro et al., 2013](https://pubmed.ncbi.nlm.nih.gov/24097267/)). By inserting sequencing adapters into accessible DNA, ATAC-seq enables high-resolution mapping of regulatory regions and provides insight into gene regulation ([Corces et al., 2017](https://pubmed.ncbi.nlm.nih.gov/28846090/); [Satpathy et al., 2019](https://pubmed.ncbi.nlm.nih.gov/31406302/)). This method has been applied across multiple tissues and disease contexts, including metabolic disorders and liver disease ([Cusanovich et al., 2018](https://pubmed.ncbi.nlm.nih.gov/29706549/); [Stuart et al., 2021](https://pubmed.ncbi.nlm.nih.gov/34062119/)).
